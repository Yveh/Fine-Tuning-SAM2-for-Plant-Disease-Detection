"""
Box Prompt Training Script - Based on baseline but using box prompts instead of point prompts
"""
import os
import random
import pandas as pd
...
def read_batch(data, visualize_data=False):
    """
    Modified to return bounding boxes instead of points
    """
    ...
    return Img, binary_mask, boxes, len(inds)
...
def main():
    print("="*70)
    print("BOX PROMPT TRAINING - Using bounding boxes instead of points")
    print("="*70)
    ...
    FINE_TUNED_MODEL_NAME = "box_prompt_sam2"
    MODEL_SAVE_DIR = "../../models/box_prompt"
    ...
    for step in range(1, MAX_STEPS + 1):
        with torch.amp.autocast(device_type='cuda'):
            image, mask, input_box, num_masks = read_batch(train_data, visualize_data=False)
            ...
            # Use box prompt instead of points
            # _prep_prompts expects box in xyxy format
    ...
    # Save training log
    log_file = "../../results/box_prompt_training_log.json"
    ...
    print("="*70)
    print("BOX PROMPT TRAINING COMPLETED!")
    print("="*70)
