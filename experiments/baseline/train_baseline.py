"""
Baseline Training Script - Exactly follows ipynb with automatic convergence detection
"""
import os
import random
import pandas as pd
...
def main():
    print("="*70)
    print("BASELINE TRAINING - IPYNB EXACT REPLICA WITH AUTO-CONVERGENCE")
    print("="*70)
    ...
    # Training parameters - EXACTLY FROM IPYNB
    MAX_STEPS = 20000  # Maximum steps (safety limit)
    FINE_TUNED_MODEL_NAME = "baseline_sam2"
    MODEL_SAVE_DIR = "../../models/baseline"
    os.makedirs(MODEL_SAVE_DIR, exist_ok=True)

    # Configure optimizer - EXACTLY FROM IPYNB
    optimizer = torch.optim.AdamW(params=predictor.model.parameters(), lr=1e-4, weight_decay=1e-4)

    # Initialize scheduler - EXACTLY FROM IPYNB
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=300, gamma=0.6)

    # Gradient accumulation - EXACTLY FROM IPYNB
    ...
    # Save training log
    log_file = "../../results/baseline_training_log.json"
